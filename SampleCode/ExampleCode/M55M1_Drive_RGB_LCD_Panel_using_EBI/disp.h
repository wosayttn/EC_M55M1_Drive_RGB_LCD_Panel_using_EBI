...
typedef enum
{
    ...
    evHStageHFP_HSYNC_HBP,   /*!< Horizontal Front Porch stage, Sync stage, Back Porch stage */
#else
...
{
#if defined(CONFIG_LCD_PANEL_USE_DE_ONLY)
    evVStageVFP_VSYNC_VBP,   /*!< Vertical Front Porch stage, Sync stage, Back Porch stage */
#else
