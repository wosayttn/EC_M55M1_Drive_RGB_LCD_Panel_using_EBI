...
#define BPWM_CMPDAT_CMPDAT_Pos           (0)                                               /*!< BPWM_T::CMPDAT: CMPDAT Position       */
#define BPWM_CMPDAT_CMPDAT_Msk           (0xfffful << BPWM_CMPDAT_CMPDAT_Pos)              /*!< BPWM_T::CMPDAT: CMPDAT Mask           */
...
#define BPWM_CAPIEN_CAPRIEN2_Ms          (0x1ul << BPWM_CAPIEN_CAPRIEN2_Pos)               /*!< BPWM_T::CAPIEN: CAPRIEN2 Mask            */
...
#define BPWM_CAPIEN_CAPFIEN1_Msk         (0x1ul << BPWM_CAPIEN_CAPFIEN1_Pos)               /*!< BPWM_T::CAPIEN: CAPFIF1 Mask            */
