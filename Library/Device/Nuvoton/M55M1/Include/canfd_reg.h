...
#define CANFD_RXF1S_F1GI_Pos              (8)                                               /*!< CANFD_T::RXF1S: F1G Position           */
#define CANFD_RXF1S_F1GI_Msk              (0x3ful << CANFD_RXF1S_F1GI_Pos)                   /*!< CANFD_T::RXF1S: F1G Mask               */

#define CANFD_RXF1S_F1PI_Pos              (16)                                              /*!< CANFD_T::RXF1S: F1P Position           */
#define CANFD_RXF1S_F1PI_Msk              (0x3ful << CANFD_RXF1S_F1PI_Pos)                   /*!< CANFD_T::RXF1S: F1P Mask               */
