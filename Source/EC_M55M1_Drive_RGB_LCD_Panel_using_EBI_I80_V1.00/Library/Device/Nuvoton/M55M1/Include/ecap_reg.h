...
typedef struct
{
     ...
     * |        |          |(The bit is read only and write is ignored)
     */
    __IO uint32_t CNT;              /*!< [0x00] Input Capture Counter (24-bit Up Counter)               */
    __IO uint32_t HLD0;             /*!< [0x04] Input Capture Hold Register 0                           */
    __IO uint32_t HLD1;             /*!< [0x08] Input Capture Hold Register 1                           */
    __IO uint32_t HLD2;             /*!< [0x0C] Input Capture Hold Register 2                           */
    __IO uint32_t CNTCMP;           /*!< [0x10] Input Capture Compare Register                          */
    __IO uint32_t CTL0;             /*!< [0x14] Input Capture Control Register 0                        */
    __IO uint32_t CTL1;             /*!< [0x18] Input Capture Control Register 1                        */
    __IO uint32_t STATUS;           /*!< [0x1C] Input Capture Status Register                           */
} ECAP_T;
