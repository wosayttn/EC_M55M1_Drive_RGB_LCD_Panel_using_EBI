...
typedef struct
{
     ...
     * |        |          |Note: When CAPSRC = 1, User can set ICAPSEL (TIMERx_EXTCTL[10:8]) to decide which internal ACMP output signal or which clock is as timer capture source.
     ...
     * |        |          |For example, while CAPIEN = 1, CAPEN = 1, and CAPEDGE = 00, a 1 to 0 transition on the TMx_EXT pin, ACMP, internal clock, or external clock will cause the CAPIF to be set then the interrupt signal is generated and sent to NVIC to inform CPU.
     ...
     * |[10:8]  |ICAPSEL   |Internal Capture Source Select
     ...
     * |        |          |110 = Capture Function source is from internal ACMP2 output signal.
     * |        |          |111 = Capture Function source is from internal ACMP3 output signal.
     ...
     * |        |          |100, 101 = Reserved.
     * |        |          |Note: Set CAPSRC (TIMERx_CTL[22]) and ICAPSEL (TIMERx_EXTCTL[10:8]) to select capture source.
     ...
     * |        |          |001 = Event Counter input source is from USB internal SOF output signal.
     ...
     * |        |          |1001~1111 = Reserved.
     * |        |          |Note: Sets ICAPSEL (TIMERx_EXTCTL[10:8]) and CAPSRC (TIMERx_CTL[22]) to select capture source.
     * @var TIMER_T::EINTSTS
     ...
     * |        |          |Note2: When CAPEN (TIMERx_EXTCTL[3]) bit is set, the transition on the capture source matched the CAPEDGE (TIMERx_EXTCTL[14:12]) setting, this bit will set to 1 by hardware.
     ...
     * |        |          |Note: This bit will be cleared automatically when user clears corresponding CAPIF.
     * @var TIMER_T::TRGCTL
     ...
     * |[1]     |TRGPWM    |Trigger EPWM and BPWM and TIMER PWM MODE Enable Bit
     * |        |          |If this bit is set to 1, each timer time-out event or capture event can be as EPWM and BPWM and TIMER PWM MODE counter clock source.
     * |        |          |0 = Timer interrupt trigger EPWM and BPWM and TIMER PWM MODE Disabled.
     * |        |          |1 = Timer interrupt trigger EPWM and BPWM and TIMER PWM MODE Enabled.
     * |        |          |Note: If TRGSSEL (TIMERx_TRGCTL[0]) = 0, time-out interrupt signal as EPWM and BPWM and TIMER PWM MODE counter clock source.
     * |        |          |If TRGSSEL (TIMERx_TRGCTL[0]) = 1, capture interrupt signal as  EPWM and BPWM and TIMER PWM MODE counter clock source.
...
#define TIMER_PWMBRKCTL_CPO2EBEN_Pos     (2)                                               /*!< TIMER_T::PWMBRKCTL: CPO2EBEN Position  */
#define TIMER_PWMBRKCTL_CPO2EBEN_Msk     (0x1ul << TIMER_PWMBRKCTL_CPO2EBEN_Pos)           /*!< TIMER_T::PWMBRKCTL: CPO2EBEN Mask      */

#define TIMER_PWMBRKCTL_CPO3EBEN_Pos     (3)                                               /*!< TIMER_T::PWMBRKCTL: CPO3EBEN Position  */
#define TIMER_PWMBRKCTL_CPO3EBEN_Msk     (0x1ul << TIMER_PWMBRKCTL_CPO3EBEN_Pos)           /*!< TIMER_T::PWMBRKCTL: CPO3EBEN Mask      */
...
#define TIMER_PWMBRKCTL_CPO2LBEN_Pos     (10)                                              /*!< TIMER_T::PWMBRKCTL: CPO2LBEN Position  */
#define TIMER_PWMBRKCTL_CPO2LBEN_Msk     (0x1ul << TIMER_PWMBRKCTL_CPO2LBEN_Pos)           /*!< TIMER_T::PWMBRKCTL: CPO2LBEN Mask      */

#define TIMER_PWMBRKCTL_CPO3LBEN_Pos     (11)                                              /*!< TIMER_T::PWMBRKCTL: CPO3LBEN Position  */
#define TIMER_PWMBRKCTL_CPO3LBEN_Msk     (0x1ul << TIMER_PWMBRKCTL_CPO3LBEN_Pos)           /*!< TIMER_T::PWMBRKCTL: CPO3LBEN Mask      */
